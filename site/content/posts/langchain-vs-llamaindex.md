...
LlamaIndex의 에이전트는 RAG 기반 데이터 검색에 초점을 맞추고 있습니다.
...
간단한 RAG나 챗봇이라면 프레임워크 없이 LLM API를 직접 호출하는 편이 더 효율적일 수 있습니다.
...
두 프레임워크 모두 빠르게 발전하고 있으므로, 프로젝트 시작 시점에 최신 기능을 반드시 확인하세요.
